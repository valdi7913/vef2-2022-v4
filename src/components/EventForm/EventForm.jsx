...
export function EventForm({ id }) {
    ...
    if (registered && registered.includes(id)) {
        return (
            <>
                <p style={{ padding: "1rem 0" }}> þú hefur verið skráð/ur á viðburðinn! </p>
                <Button type='submit' onClick={unregister}> Afskrá mig </Button>
            </>
        );
    }
    ...
    return (
        <Form>
            ...
            <Button onClick={register} type='submit'> Skrá mig </Button>
        </Form>
    );
}